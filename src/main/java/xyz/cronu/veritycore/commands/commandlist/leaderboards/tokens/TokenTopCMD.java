...
public class TokenTopCMD extends SubcommandBase {
	@Override
	...
	public void perform(CommandSender sender, String[] args) throws IOException, DataException {
		...
		Map<String, Double> prestigeTop = LeaderboardManager.getLeaderboard().getTokenTop();
		int postion = 1;
		Text.message(sender, "&8&m--------------&r &4&lTOKEN TOP &8&m--------------");
		Text.message(sender, "");
