...
public class PrestigeTopCMD extends SubcommandBase {
	@Override
	...
	public void perform(CommandSender sender, String[] args) throws IOException, DataException {
		...
		Map<String, Double> prestigeTop = LeaderboardManager.getLeaderboard().getPrestigeTop();
		int postion = 1;
		Text.message(sender, "&8&m--------------&r &4&lPRESTIGE TOP &8&m--------------");
		Text.message(sender, "");
